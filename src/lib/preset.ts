...
export let default_struct: block[] = [
   [ { type: "text", id: 0 } ],
   [ { type: "text", id: 1 }, { type: "text", id: 2 } ],
   [ { type: "image", id: 0 }, { type: "image", id: 1 }, { type: "image", id: 2 } ],
   [ { type: "text", id: 5 } ],
   [ { type: "text", id: 6 } ],
   [ { type: "image", id: 3 },  { type: "text", id: 7 } ],
   [ { type: "text", id: 8 }, { type: "image", id: 4 } ],
   [ { type: "text", id: 9 } ],
   [ { type: "text", id: 3 }, { type: "text", id: 4 } ],
   [ { type: "text", id: 10 } ],
];
...
export let default_texts: text[] = [
   ...
   AMPL!FY
   BRAND
   When creating AML!FY, we chose a strong identity that can carry itself through digital and physical environments while evoking a consistent response.`, style: "normal", size: "medium" },
